...
async function handler(m, { conn: _envio, usedPrefix }) {
  ...
  if (!global.conns) {
    console.error('global.conns no está definida');
    await _envio.sendMessage(m.chat, { text: 'Error: no se pudo obtener la lista de sub bots porque global.conns no está definida.' }, { quoted: m });
    return;
  }
