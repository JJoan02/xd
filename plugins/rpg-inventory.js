...
┃ ${rpgg.emoticon('money')} *JoanCoins: » ${money}*
...
_2.Top JoanCoins_ *${usersmoney.indexOf(m.sender) + 1}* _de_ *${usersmoney.length}*
...
*│ ⛏️🐱 Minar JoanCoins » ${new Date - user.lastcoins < 600000 ? '❌' : '✅'}*
...
*╰─⋆─⋆─⋆─⋆─⋆─⋆─⋆─⋆─┄⸙*`.trim()//`
conn.sendFile(m.chat, imgr, 'joan.jpg', caption, fkontak, m, { mentions: conn.parseMention(caption) })
...
conn.sendFile(m.chat, imgr, 'joan.jpg', str, {quoted: fkontak})
...
╰────────────────\n\n
*/
conn.sendFile(m.chat, imgr, 'joan.jpg', str, fkontak, m, { mentions: conn.parseMention(str) })
...
┃💐 *Caja de Jardinería : Garden boxs » ${user.gardenboxs}*
╰━━━━━━━━━⬣`.trim()
conn.sendFile(m.chat, imgr, 'joan.jpg', aineh, fkontak, m)}
