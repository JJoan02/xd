...
if (!text) {
if (!usuarioExistente) {
fake = { contextInfo: { externalAdReply: { title: `🌟 ¡Colecciona Personajes!`, body: `Compra un personaje y vuelve aquí`, sourceUrl: accountsgb, thumbnailUrl: joanMenu }}}
...
fake = { contextInfo: { externalAdReply: { title: `😅 ¡No tienes Personajes!`, body: `Vuelve a comprar y regresa aquí`, sourceUrl: accountsgb, thumbnailUrl: joanMenu }}}
...
await conn.sendFile(m.chat, joanImg.getRandom(), 'fantasy.jpg', `> Use *${usedPrefix + command} nombre o código* del personaje\n\n` + listaPersonajes, fkontak, true, {
contextInfo: {
'forwardingScore': 200,
'isForwarded': false,
externalAdReply: {
...
fake = { contextInfo: { externalAdReply: { title: `🤨 ¡Verifique el nombre o código!`, body: `Escriba ${usedPrefix + command} para ver sus personajes`, sourceUrl: accountsgb, thumbnailUrl: joanMenu }}}
...
fake = { contextInfo: { externalAdReply: { title: `🌟 Personajes de clase: ${imageClass}`, body: `Puedes hacer un solo cambio por 🤩🎟️`, sourceUrl: accountsgb, thumbnailUrl: joanMenu }}}
...
const tiempoTotalFormateado = formatearTiempo(tiempoTotal * 60 * 1000, true)
fake = { contextInfo: { externalAdReply: { title: `✅ ¡${personajesMismaClase.length} Personajes cambiados!`, body: `🎟️ Tienes Premium por: ${tiempoPremiumFormateado} `, sourceUrl: accountsgb, thumbnailUrl: joanMenu }}}
