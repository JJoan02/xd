...
const smsLista1 = () => { return `🌟 INFORMASI JOANBOT 🌟`}
...
const smsLista7 = () => { return `🐈 PASANG JOANBOT 🐈`}
...
const smsModP2 = () => { return `Aktifkan fungsi agar semua orang dapat menggunakan JoanBot`}
const smsModAd1 = () => { return `🛂 MODE ADMIN`}
const smsModAd2 = () => { return `Hanya Admin yang dapat menggunakan JoanBot di Grup`}
...
const smsContacto4 = () => { return 'Kontak Resmi JoanBot 🐈'}
